		...
		<section>
			<div class="row mx-0 my-2"><!--Inicio da Row-->
				...
				<div class="col-sm-2 mb-5 mt-5">
					...
					<div class="mt-2 mb-2">
						<a href="cliente.php" class="btn btn-warning btn-block ml-2 font-weight-bold text-dark active"><i class="fas fa-user mr-2"></i>Cliente</a>
							...
							<tbody>
								<?php foreach ($readClientes as $modelcli) { ?>
									<tr>
										...
										<td>
											<a href="cliente.php?idup=<?= $modelcli->idcliente ?>" class="fas fa-edit text-info" ></a>
										</td>
										<!--<td>
