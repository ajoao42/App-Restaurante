...
<body class="bg-secondary">
  ...
  <section>
      ...
      <div class="col-sm-2 mb-5 mt-5">
        ...
        <div class="mt-2 mb-2">
          <a href="home_User.php" class="btn btn-warning btn-block ml-2 font-weight-bold text-dark active"><i class="fas fa-home mr-2"></i>Home</a>
  ...
  <footer>
    <div class="bg-dark text-white pt-2 pb-2 pl-2 pr-3" style="margin-top: 10px;">
      <div class="row">
        <div class="col-sm-9">
