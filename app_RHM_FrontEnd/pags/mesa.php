	...
	<section>
		<div class="row mx-0 my-2"><!--Inicio da Row-->
			...
			<div class="col-sm-2 mb-5 mt-5">
				...
				<div class="mt-2 mb-2">
					<a href="mesa.php" class="btn btn-warning btn-block ml-2 font-weight-bold text-dark active"><i class="fas fa-table mr-2"></i>Mesa</a>
							...
							<tbody>
								<?php foreach ($readMesa as $mesa) { ?> 
									<tr>
										...
										<td>
											<a href="mesa.php?idup=<?= $mesa->idmesa ?>"><i class="fas fa-edit text-info"></i>
											</a>
										</td>
										<!--<td>
