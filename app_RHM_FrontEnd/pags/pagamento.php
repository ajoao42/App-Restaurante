	...
	<header>
		<nav class="navbar navbar-expand-sm navbar-dark bg-dark">
			...
			<a href="home.php" class="navbar-brand">
				<h3 class="text-white font-weight-bold">Restaurante <span class="text-warning">Hotel Miradouro</span><i class="fas fa-hotel ml-2"></i></h3>	
	...
	<section>	
		<div class="row mx-0 my-2"><!--Inicio da Row-->
			...
			<div class="col-sm-2 mb-5 mt-5">
				...
				<div class="mt-2 mb-2">
					<a href="pagamento.php" class="btn btn-warning btn-block ml-2 font-weight-bold text-dark active"><i class="fas fa-credit-card mr-2"></i>Pagamento</a>
			...
			<div class="col-sm-3 mb-5 mt-3 border rounded bg-dark border-warning">
				...
				<div class=" form-group text-white"><!--Inicio da Div do formulario-->
					...
					<form action="<?php if(isset($pag)) { ?> controller.php?accao=updatePagamento <?php } else{ ?>controller.php?accao=creatPagamento<?php } ?>" method="POST">
						...
						<label for="menu" class="text-white font-weight-bold">Pedido</label>
						<select name="pedido" class="form-control mb-2 border border-warning" id="cliente">
						...
						<select name="qtd" class="form-control mb-2 border border-warning" id="cliente">
					...
					<table class="table table-sm text-white"><!--Inicio da tablea-->
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<a href="pagamento.php?idup=<?= $pag->idpagamento ?>"><i class="fas fa-edit text-info"></i>
									</a>
								</td>
								<td>
									<a href="factura.php?idfa=<?= $pag->idfactura ?>"><i class="fas fa-print text-light"></i></a>
								</td>
								<td>
...
<!--Inicio do Rodapé do App-->
	<footer>
		<div class="bg-dark text-white pt-2 pb-2 pl-2 pr-3 mt-3">
			<div class="row">
				<div class="col-sm-9">
