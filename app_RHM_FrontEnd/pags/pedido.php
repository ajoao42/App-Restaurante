	...
	<section>
		<div class="row mx-0 my-2"><!--Inicio da Row-->
			...
			<div class="col-sm-2 mb-5 mt-5">
				...
				<div class="mt-2 mb-2">
					<a href="pedido.php" class="btn btn-warning btn-block ml-2 font-weight-bold text-dark active"><i class="fas fa-edit mr-2"></i>Pedido</a>
							...
							<tbody>
								<?php foreach ($readPedido as $pedido) { ?>
									<tr>
										...
										<td>
											<a href="pedido.php?idup=<?= $pedido->idpedido ?>"><i class="fas fa-edit text-info"></i>
											</a>
										</td>
