	...
	<section>
		<div class="row mx-0 my-2"><!--Inicio da Row-->
			...
			<div class="col-sm-2 mb-5 mt-5">
				...
				<div class="mt-2 mb-2">
					<a href="reserva.php" class="btn btn-warning btn-block ml-2 font-weight-bold text-dark active"><i class="fas fa-list-alt mr-2"></i>Reserva</a>
							...
							<tbody class="text-center">
								<?php foreach ($readReserva as $reserva) { ?>
									<tr>
										...
										<td>
											<a href="reserva.php?idup=<?= $reserva->idreserva ?>"><i class="fas fa-edit text-info"></i>
											</a>
										</td>
										<td>
